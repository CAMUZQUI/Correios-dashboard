...
function actualizarArchivoGitHub(datosTransformados) {
    ...
    .then(data => {
        ...
        */
        ...
        .then(data => {
            console.log(data);
            // Aquí es donde recargarías la página, usando setTimeout para dar tiempo a que el cambio se propague.
            setTimeout(function() {
                window.location.reload(true); // El argumento 'true' hace que la página se recargue desde el servidor, no desde la caché.
